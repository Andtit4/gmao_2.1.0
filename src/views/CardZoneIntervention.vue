    ...
    <table>
      ...
      <tbody>
        <tr v-for="(site, index) in zones.list" :key="index">
          ...
          <td data-label="Zone" style="font-size: 10px; height: 10px;">
